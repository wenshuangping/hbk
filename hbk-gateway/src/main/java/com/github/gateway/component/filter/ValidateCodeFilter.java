...
public class ValidateCodeFilter extends ZuulFilter {
    ...
    public boolean shouldFilter() {
        ...
        if (StrUtil.containsAnyIgnoreCase(request.getRequestURI(), SecurityConstants.MOBILE_TOKEN_URL)) {
            return true;
        }
        return false;
    }
